...
urlpatterns = [
    ...
    url(r'^versions/(?P<contest_slug>[\w]*)/(?P<task_title>[\w]*)/$', Versions.as_view(), name='versions'),
    url(r'^task_versions/(?P<id>[\w]*)/$', TaskVersions.as_view(), name='taskVersions'),
    url(r'^translations/(?P<contest_slug>[\w]*)/(?P<task_title>[\w]*)/$', Questions.as_view(), name='question'),
