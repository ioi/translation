...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='create_time',
            field=models.DateTimeField(default=datetime.datetime(2017, 5, 12, 5, 29, 40, 745421, tzinfo=timezone.utc)),
        ),
        migrations.AlterField(
            model_name='task',
            name='uploaded_file',
        ...
        migrations.AlterField(
            ...
            name='create_time',
            field=models.DateTimeField(default=datetime.datetime(2017, 5, 12, 5, 29, 40, 752308, tzinfo=timezone.utc)),
        ),
    ]
